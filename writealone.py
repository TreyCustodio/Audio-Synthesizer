...
def piano():
    ...
    #   Variant 1   #
    m1 = build_measure(n3.q_a + n3.q_f, # 1
                       fade_mult(n3.q_a + n3.q_f, n3.q_a + n3.q_f, 2, 0.0, fade_factor)

    )


    m2 = build_measure(n3.q_g + n3.q_e, # 1
                       fade_mult(n3.q_g + n3.q_e, n3.q_g + n3.q_e, 2, 0.0, fade_factor)
    )
...
def piano():
    ...
    m1 = build_measure(n6.q_g, 
                       n6.q_a, 
                       n6.e_g, n6.q_a,
                       n6.e_g, n6.q_a, 
                       n6.q_a, n6.q_g)
     
    final = build_measure(m1)
