...
class FPDG(Beat):
    def __init__(self, bpm):
        super().__init__(bpm, path = os.path.join("AMTR", "ost", "12"))
        mod = 0.5
       ...
       #    Kicks   #
        ...
        self.kick5 = GlobalSample(amp=0.00002, file_path=os.path.join("samples", "kick", "deep-kick_1.wav"))
        ...
        #   ----- MIDIs -----   #
        self.full_midi = GlobalSample(0.00003, os.path.join("samples", "AMTR", "12_full.wav"))



        #   ----- Samples ----- #
        self.go = GlobalSample(0.00001, os.path.join("samples", "go_low.wav"))
        self.voice = GlobalSample(0.00001, os.path.join("samples", "has", "vocal_1.wav"))
        self.ha1 = GlobalSample(0.00003, os.path.join("samples", "has", "ha_1.wav"))
        pan_amp = 0.000012
        self.panc = GlobalSample(pan_amp, os.path.join("samples", "steel", "steel_pan_c.wav"))
        self.pana = GlobalSample(pan_amp, os.path.join("samples", "steel", "steel_pan_a.wav"))
    ...
    def get_instruments(self, verse = "full"):
        self.instruments = {
            ...
            "hat": [0, self.hats(verse)],
            "pan": [0, self.pan(verse)],
            ...
            #   Samples / Libs  #
            # "vocals": [0, self.vocals_1(verse)],

            #   Midi    #
            # "midi": [0, self.midi_full(verse)]

        }

    def midi_full(self, verse):
        m = self.full_midi

        full = [m.n(self.w*56)]
        intro = [m.n(self.w*8)]
        main = [m.n(self.w*56, start_time=self.w*8)]
    ...
    def hats(self, verse):
        ...
        m1 = [
            ...
            h.n(self.e), h.n(self.e),
            h.n(self.e), h.n(self.e),
            h.n(self.e), h.n(self.s/2), h.n(self.s/2), h.n(self.s),
        ]
...
def main():
    ...
    beat.export_selection(name="12_full", volume=30_500)
