...
class L(Beat):
    def __init__(self, bpm):
        super().__init__(bpm, path=os.path.join("project_l"))
    ...
    def get_instruments(self):
        self.instruments = {
            #   Rhythm and Bass #
            # 'kick1': [self.kick1, self.kicks_1()],
            # 'snare1': [self.snare1, self.snares_1()],
            # 'hats1': [self.hat1, self.hats_1()],
            # 'hats2': [self.hat2, self.hats_2()],
            'bass1': [self.bass1, self.bass_1()],
            # 'whistle1': [self.whistle1, self.whistle_1()],
            


            #   Melody  #
            # 'harp1': [self.harp1, self.harp_1()],
            'piano1': [self.piano1, self.piano_1()],
            # 'flute': [self.p1, self.flute_1()],
